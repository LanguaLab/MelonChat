...
import blue.melon.lab.minecraft.melonchat.message.Text
import blue.melon.lab.minecraft.melonchat.message.TextFormat
...
object Utils {
    ...
    private val chars = "23456789ABCDEFHKMNPQRSTUVWXYZ+$%"
